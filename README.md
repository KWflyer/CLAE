...
1. Your can download the the source CWRU dataset from  
   ...
   In our experiments, the used raw CWRU data are selected and saved as the file "Sample_12k_Drive_End_Bearing_Fault_Data_DE.mat", and the used CWRU data with the additive Gaussian white noise, which are shared at **Baidu  Netdisk** (<font color=#0099ff size=3 face="Times New Roman">**Link:**</font> https://pan.baidu.com/s/1nqtJupUdL3TXY5dKjjHUsg ; **Extraction Code:** kheh) due to the capacity limitation of Github. You can freely download this data file.
