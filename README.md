...
1. Your can download the the source CWRU dataset from  
   ...
   In our experiments, the used raw CWRU data are selected and saved as the file "Sample_12k_Drive_End_Bearing_Fault_Data_DE.mat", and the used CWRU data with the additive Gaussian white noise, which are shared at **Baidu  Netdisk** (link:https://pan.baidu.com/s/1nqtJupUdL3TXY5dKjjHUsg <br> Extraction Code: kheh) <br>due to the capacity limitation of Github. You can freely download this data file.
